...
class Plan extends HookConsumerWidget {
  ...
  const Plan({Key? key, required this.friendId}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection('todo').where('friendId', isEqualTo: friendId).snapshots(),
          ...
          if (snapshot.hasData) {
            return ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                DateTime startDateTime = data['startDateTime'].toDate();
                DateTime endDateTime = data['endDateTime'].toDate();
